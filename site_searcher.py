...
if __name__ == "__main__":
    ...
    param_names = [action.dest for action in parser._actions if action.dest not in ('help', 'config_path', 'log_path')]
    ...
    # Post-validation of absolutely required parameters
